...
<head>
    ...
    <style>
        ...
        .ejercicio-card { background: #111; border: 1px solid rgba(34,197,94,0.3); padding: 25px; margin-bottom: 15px; display: flex; align-items: center; gap: 20px; transition: all 0.3s; }
        .ejercicio-card:hover { border-color: #22c55e; box-shadow: 0 0 25px rgba(34,197,94,0.2); transform: translateX(5px); }
        .ejercicio-numero { width: 50px; height: 50px; background: #22c55e; color: #000; font-family: 'Orbitron', sans-serif; font-size: 20px; font-weight: 900; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
        .ejercicio-info h3 { font-family: 'Orbitron', sans-serif; font-size: 16px; color: #fff; margin: 0 0 5px 0; letter-spacing: 2px; }
        .ejercicio-info p { font-family: 'Rajdhani', sans-serif; font-size: 14px; color: #9ca3af; margin: 0; }
...
<body>
    ...
    <div class="ejercicios-container">
        ...
        <h1 style="font-family:'Orbitron',sans-serif;color:#22c55e;letter-spacing:5px;margin-bottom:30px;">☠ EJERCICIOS - SEMANA <%= weekParam %></h1>
